...
void PetProcessSupervisor::launchNow(ChildState* child) {
    ...
    child->process.setArguments({
        ...
        spec.gameTopmost ? QStringLiteral("true") : QStringLiteral("false"),
        QStringLiteral("--obs-window-capture-compatible"),
        spec.obsWindowCaptureCompatible ? QStringLiteral("true") : QStringLiteral("false"),
        ...
        QString::number(spec.compactAiWindowOpacity),
        QStringLiteral("--compact-ai-window-font-size"),
        QString::number(spec.compactAiWindowFontSize),
        QStringLiteral("--compact-ai-window-background-color"),
        spec.compactAiWindowBackgroundColor,
        QStringLiteral("--compact-ai-window-text-color"),
        spec.compactAiWindowTextColor,
        QStringLiteral("--ai-event-overlay-enabled"),
        spec.aiEventOverlayEnabled ? QStringLiteral("true") : QStringLiteral("false"),
        QStringLiteral("--chat-integration-overlay-enabled"),
        spec.chatIntegrationOverlayEnabled ? QStringLiteral("true") : QStringLiteral("false"),
