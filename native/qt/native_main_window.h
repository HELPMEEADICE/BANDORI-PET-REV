...
private:
    ...
    void selectModelBand(const QString& bandId);
    void selectModelCharacter(const QString& character);
    void selectModelPath(const QString& path);
    QJsonArray modelBands() const;
    QString modelBandDisplay(const QString& character) const;
...
private:
    ...
    QStackedWidget* modelPageStack_ = nullptr;
    QWidget* modelDetailPage_ = nullptr;
    QWidget* modelPickerPage_ = nullptr;
    QGridLayout* modelPickerGridLayout_ = nullptr;
    qfw::TitleLabel* modelPickerTitle_ = nullptr;
    qfw::SubtitleLabel* modelPickerSubtitle_ = nullptr;
    qfw::LineEdit* modelSearchEdit_ = nullptr;
    qfw::ComboBox* modelFilterComboBox_ = nullptr;
    qfw::PushButton* modelBackButton_ = nullptr;
    qfw::TitleLabel* modelNameLabel_ = nullptr;
    qfw::StrongBodyLabel* modelCostumeLabel_ = nullptr;
    qfw::BodyLabel* modelBandLabel_ = nullptr;
    QString modelPickerBand_;
    QString modelPickerCharacter_;
