...
private:
    ...
    QString chatAvatarPath(const QString& character) const;
    QString groupDisplayName(const QString& groupKey) const;
    void selectGroupKeyMembers(const QString& groupKey);
    void syncChatPresentationControls();
    bool saveChatPresentationSettings(const QJsonObject& changes);
    void toggleCurrentChatPin();
    void renameCurrentPrivateChat();
    void chooseCurrentChatAvatar();
    void resetCurrentChatAvatar();
    void toggleGroupChatSidebar();
    void scheduleGroupChatLayoutSave();
    void applyChatWindowPolicy();
...
private:
    ...
    QSplitter* chatGroupSplitter_ = nullptr;
    ...
    qfw::SwitchButton* gpuAccelerationSwitch_ = nullptr;
    ...
    qfw::SwitchButton* chatWindowAlwaysOnTopSwitch_ = nullptr;
