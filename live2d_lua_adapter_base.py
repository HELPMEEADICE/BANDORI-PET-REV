...
def _install_lazy_lua_module_loader(lua: LuaRuntime, root: Path, extra_module_patch=None):
    ...
    def load_module_source(name):
        ...
        return chunk, ("@" + module_path.as_posix()).encode("utf-8")
...
class LuaLive2DRuntimeBase:
    ...
    def _new_options(self, model_path: str, decode_textures: bool = False):
        self._ensure_runtime()
        lua = self._lua
